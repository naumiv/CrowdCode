...
clienRequestApp.controller('ClientRequestController', ['$scope','$rootScope','$firebase','$alert', function($scope,$rootScope,$firebase,$alert) {
    ...
    var firebaseURL = 'https://crowdcode2.firebaseio.com';//'https://crowdcode.firebaseio.com';
    var firebaseRef;
    $scope.projectsName=[];
    ...
    $scope.functions = [];
    $scope.projectName="";
    $scope.designDoc = {title : "", description: "" };
    ...
    $scope.submit=function(form){
        ...
        if (form.$invalid) {
            ...
            project.$loaded().then(function(){
                ...
                project.designDoc = $scope.designDoc;
                console.log(project);
    ...
    $scope.load=function()
    {
        ...
        project.$loaded().then(function(){
            ...
            if(angular.isDefined(project.designDoc))
                $scope.designDoc=project.designDoc;
            else
                $scope.designDoc={title : "", description: "" };
